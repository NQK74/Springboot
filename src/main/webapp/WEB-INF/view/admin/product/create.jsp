...
<head>
    ...
    <title>Tạo Sản Phẩm - LaptopShop</title>
            ...
            <main>
                <div class="container-fluid px-4">
                    <div class="page-header">
                        <h1><i class="fas fa-plus-circle me-2"></i>Tạo Sản Phẩm Mới</h1>
                        <ol class="breadcrumb">
                                ...
                                <div class="form-body">
                                    <form:form method="post" action="/admin/product/create" modelAttribute="newProduct" enctype="multipart/form-data">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group">
                                                <label for="price" class="form-label"><i class="fas fa-dollar-sign me-2"></i>Giá <span style="color: #dc3545;">*</span></label>
                                        ...
                                        <div class="button-group">
                                            ...
                                            <button type="submit" class="btn-action btn-submit">
                                                <i class="fas fa-check"></i>Tạo Sản Phẩm
                                            </button>
                                        </div>
                                    </form:form>
                                </div>
